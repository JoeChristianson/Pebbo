...
export const Modal = ({additionalButtons,highlight,userId,setModalOpen,modalInput,handleDelete,dataId,handlePrioritize,handleSettings,notes,children,onDash})=>{
